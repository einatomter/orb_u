...
public:
    ...
    void static BundleAdjustment(const std::vector<KeyFrame*> &vpKF, const std::vector<MapPoint*> &vpMP,
                                 ...
                                 const bool bRobust = true, bool isUW = false);
    void static GlobalBundleAdjustemnt(Map* pMap, int nIterations=5, bool *pbStopFlag=NULL,
                                       const unsigned long nLoopKF=0, const bool bRobust = true, bool isUW = false);
    ...
    void static LocalBundleAdjustment(KeyFrame* pKF, bool *pbStopFlag, Map *pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges, bool isUW = false);

    int static PoseOptimization(Frame* pFrame, bool isUW = false);
    int static PoseInertialOptimizationLastKeyFrame(Frame* pFrame, bool bRecInit = false, bool bUW = false);
    int static PoseInertialOptimizationLastFrame(Frame *pFrame, bool bRecInit = false, bool bUW = false);
    ...
    void static LocalInertialBA(KeyFrame* pKF, bool *pbStopFlag, Map *pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges, bool bLarge = false, bool bRecInit = false, bool bUW = false);
