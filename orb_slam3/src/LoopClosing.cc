...
bool LoopClosing::NewDetectCommonRegions()
{
    ...
    {
        // UW
        std::cout << "LoopClosure: Detecting loop geometric in KF " << mpCurrentKF->mnId << std::endl;
...
{  
    ...
    // TODO: add globalBA with depth term when isUW variable added to this thread
    if(!bImuInit)
